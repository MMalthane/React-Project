  ...
  render(){
   ...
   <div className="cell">
      <article className="article">
        <h1 className="article-title">Videos, Related to Robotics</h1>
        ...
        <div className="article-body">
          ...
          <div className="article-body-video">
            <img src="assets/images/streaming-video-icon.jpg" />
...
<CommentBox apiUrl="api/video/comments.json" />
